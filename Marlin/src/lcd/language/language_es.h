...
namespace Language_es {
  ...
  PROGMEM Language_Str MSG_BACK                            = _UxGT("Atras");
  ...
  PROGMEM Language_Str MSG_MEDIA_RELEASED                  = _UxGT("SD/USB expulsado");
  ...
  PROGMEM Language_Str MSG_LCD_SOFT_ENDSTOPS               = _UxGT("Softw. Endstops");
  ...
  PROGMEM Language_Str MSG_DEBUG_MENU                      = _UxGT("Menu depuracion");
  ...
  PROGMEM Language_Str MSG_LEVEL_BED_DONE                  = _UxGT("¡Nivelacion lista!");
  PROGMEM Language_Str MSG_Z_FADE_HEIGHT                   = _UxGT("Compensacion Altura");
  ...
  PROGMEM Language_Str MSG_LASER_OFF                       = _UxGT("Laser Apagado");
  PROGMEM Language_Str MSG_LASER_ON                        = _UxGT("Laser Encendido");
  PROGMEM Language_Str MSG_LASER_POWER                     = _UxGT("Potencia Laser");
  ...
  PROGMEM Language_Str MSG_M48_DEVIATION                   = _UxGT("Desviacion");
  PROGMEM Language_Str MSG_IDEX_MENU                       = _UxGT("Modo IDEX");
  PROGMEM Language_Str MSG_OFFSETS_MENU                    = _UxGT("Desfase Hotends");
  ...
  PROGMEM Language_Str MSG_HOTEND_OFFSET_X                 = _UxGT("2ª Hotend X");
  PROGMEM Language_Str MSG_HOTEND_OFFSET_Y                 = _UxGT("2ª Hotend Y");
  PROGMEM Language_Str MSG_HOTEND_OFFSET_Z                 = _UxGT("2ª Hotend Z");
  ...
  PROGMEM Language_Str MSG_LCD_TILTING_MESH                = _UxGT("Punto de inclinacion");
  ...
  PROGMEM Language_Str MSG_UBL_BUILD_COLD_MESH             = _UxGT("Crear Mallado Frio");
  ...
  PROGMEM Language_Str MSG_G26_HEATING_NOZZLE              = _UxGT("G26 Calent. Hotend");
  ...
  PROGMEM Language_Str MSG_G26_PRIME_DONE                  = _UxGT("Imprimacion Lista");
  ...
  PROGMEM Language_Str MSG_UBL_STORAGE_SLOT                = _UxGT("Slots de memoria");
  ...
  PROGMEM Language_Str MSG_UBL_1_BUILD_COLD_MESH           = _UxGT("1.Crear Mallado Frio");
  ...
  PROGMEM Language_Str MSG_NOZZLE                          = _UxGT("Hotend");
  PROGMEM Language_Str MSG_NOZZLE_N                        = _UxGT("Hotend ~");
  ...
  PROGMEM Language_Str MSG_RESTORE_DEFAULTS                = _UxGT("Rest. fabrica");
  ...
  PROGMEM Language_Str MSG_START_PRINT                     = _UxGT("Iniciar impresion");
  ...
  PROGMEM Language_Str MSG_PRINT_ABORTED                   = _UxGT("Impresion cancelada");
  ...
  PROGMEM Language_Str MSG_SINGLENOZZLE_RETRACT_SPD        = _UxGT("Vel. de retraccion");
  PROGMEM Language_Str MSG_NOZZLE_STANDBY                  = _UxGT("Colocar Hotend");
  ...
  PROGMEM Language_Str MSG_SKEW_FACTOR                     = _UxGT("Factor de desviacion");
  ...
  PROGMEM Language_Str MSG_BLTOUCH_MODE_CHANGE             = _UxGT("PELIGRO: ¡Una mala configuracion puede producir daños! ¿Proceder igualmente?");
  ...
  PROGMEM Language_Str MSG_HEATING_FAILED_LCD_CHAMBER      = _UxGT("Calent. Cam. fallido");
  ...
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY_BED             = _UxGT("FUGA TERMICA CAMA");
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY_CHAMBER         = _UxGT("FUGA TERMICA CAMARA");
  PROGMEM Language_Str MSG_ERR_MAXTEMP                     = _UxGT("Err:TEMP. MAX");
  PROGMEM Language_Str MSG_ERR_MINTEMP                     = _UxGT("Err:TEMP. MIN");
  PROGMEM Language_Str MSG_ERR_MAXTEMP_BED                 = _UxGT("Err:TEMP. MAX CAMA");
  PROGMEM Language_Str MSG_ERR_MINTEMP_BED                 = _UxGT("Err:TEMP. MIN CAMA");
  PROGMEM Language_Str MSG_ERR_MAXTEMP_CHAMBER             = _UxGT("Err:TEMP. MAX CAMARA");
  PROGMEM Language_Str MSG_ERR_MINTEMP_CHAMBER             = _UxGT("Err:TEMP. MIN CAMARA");
  ...
  PROGMEM Language_Str MSG_CHAMBER_HEATING                 = _UxGT("Calentando Camara...");
  PROGMEM Language_Str MSG_CHAMBER_COOLING                 = _UxGT("Enfriando Camara...");
  ...
  PROGMEM Language_Str MSG_DELTA_SETTINGS                  = _UxGT("Configuracion Delta");
  PROGMEM Language_Str MSG_DELTA_AUTO_CALIBRATE            = _UxGT("Auto Calibracion");
  ...
  #if LCD_WIDTH >= 20
    PROGMEM Language_Str MSG_INFO_PRINT_COUNT              = _UxGT("Cont. de impresion");
  ...
  #endif
  PROGMEM Language_Str MSG_INFO_MIN_TEMP                   = _UxGT("Temp. Minima");
  PROGMEM Language_Str MSG_INFO_MAX_TEMP                   = _UxGT("Temp. Maxima");
  PROGMEM Language_Str MSG_INFO_PSU                        = _UxGT("Fuente alimentacion");
  ...
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_OPTION_PURGE    = _UxGT("Purgar mas");
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_OPTION_RESUME   = _UxGT("Continuar imp.");
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_NOZZLE          = _UxGT("  Hotend: ");
  PROGMEM Language_Str MSG_RUNOUT_SENSOR                   = _UxGT("Sensor de seccion");
  ...
  PROGMEM Language_Str MSG_CYCLE_MIX                       = _UxGT("Mezcla Ciclica");
  ...
  PROGMEM Language_Str MSG_MAZE                            = _UxGT("Maze");
  ...
  #if LCD_HEIGHT >= 4
    PROGMEM Language_Str MSG_ADVANCED_PAUSE_WAITING        = _UxGT(MSG_2_LINE("Pulsar el boton para", "reanudar impresion"));
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_INSERT        = _UxGT(MSG_3_LINE("Inserte el filamento", "y pulse el boton", "para continuar..."));
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_HEAT          = _UxGT(MSG_2_LINE("Pulse el boton para", "calentar el hotend"));
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_HEATING       = _UxGT(MSG_2_LINE("Calentando hotend", "Espere por favor..."));
  ...
  PROGMEM Language_Str MSG_TMC_HYBRID_THRS                 = _UxGT("Limite Hibrido");
